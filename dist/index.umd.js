(function (global, factory) {
  ...
  const qrCodes$3 = {};
  const Back$2 = /*#__PURE__*/React__default["default"].forwardRef((_ref, ref) => {
    let {
      member,
      fieldsMapping,
      preview
    } = _ref;
    const qrId = preview ? `qr-code-preview` : `qr-code-${member[fieldsMapping[fields$3.uid]]}`;
    const qrCode = member[fieldsMapping[fields$3.qrCode]];
    React__default["default"].useEffect(() => {
      if (fieldsMapping[fields$3.qrCode]) {
        const el = document.getElementById(qrId);

        if (qrCodes$3[qrId] && qrCodes$3[qrId]._el === el) {
          qrCodes$3[qrId].clear();
          qrCodes$3[qrId].makeCode(qrCode);
        } else {
          qrCodes$3[qrId] = new QRCode(document.getElementById(qrId), {
            text: qrCode,
            height: 230,
            width: 230
          });
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      className: "qr-code",
      id: qrId
    }, !fieldsMapping[fields$3.qrCode] && /*#__PURE__*/React__default["default"].createElement("p", {
      className: "qr-code-placeholder"
    }, `{${fields$3.qrCode}}`)), /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  const Front$2 = /*#__PURE__*/React__default["default"].forwardRef((_ref, ref) => {
    let {
      member,
      avatarFormat,
      fieldsMapping,
    ...
    const avatarUrl = member[fieldsMapping[fields$3.avatar]];
    React__default["default"].useEffect(() => {
    ...
    const avatarPicture = fieldsMapping[fields$3.avatar] ? /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    }, field(member, fieldsMapping, fields$3.position)), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "body"
    }, /*#__PURE__*/React__default["default"].createElement("div", {
      className: "side"
    }, 'Valid until ' + field(member, fieldsMapping, fields$3.expitarion)), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "center"
    }, /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      className: "value"
    }, field(member, fieldsMapping, fields$3.firstName)), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "value last-name"
    }, field(member, fieldsMapping, fields$3.lastName))), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "logos"
    }, /*#__PURE__*/React__default["default"].createElement("img", {
      className: "nca-logo",
      src: ncaLogoBase64,
    ...
    }, member[fieldsMapping[fields$3.memberNumber]] ? getMemberType(member[fieldsMapping[fields$3.memberNumber]].slice(1)) : '\u00A0'), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "footer-2 bold"
    }, field(member, fieldsMapping, fields$3.memberNumber) || '\u00A0'));
  });
  ...
  const Back$1 = /*#__PURE__*/React__default["default"].forwardRef((_ref, ref) => {
    ...
    const qrId = preview ? `qr-code-preview` : `qr-code-${member[fieldsMapping[fields$2.uid]]}`;
    const qrCode = member[fieldsMapping[fields$2.qrCode]];
    React__default["default"].useEffect(() => {
      if (fieldsMapping[fields$2.qrCode]) {
        const el = document.getElementById(qrId);

        if (qrCodes$2[qrId] && qrCodes$2[qrId]._el === el) {
          qrCodes$2[qrId].clear();
          qrCodes$2[qrId].makeCode(qrCode);
        } else {
          qrCodes$2[qrId] = new QRCode(document.getElementById(qrId), {
            text: qrCode,
            height: 230,
            width: 230
          });
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      className: "qr-code",
      id: qrId
    }, !fieldsMapping[fields$2.qrCode] && /*#__PURE__*/React__default["default"].createElement("p", {
      className: "qr-code-placeholder"
    }, `{${fields$2.qrCode}}`)), /*#__PURE__*/React__default["default"].createElement("img", {
      className: "merit-logo",
      src: meritLogoBase64,
      alt: "merit-logo"
    }))));
  ...
  const Front$1 = /*#__PURE__*/React__default["default"].forwardRef((_ref, ref) => {
    ...
    }, /*#__PURE__*/React__default["default"].createElement(ScaledText, {
      text: field(member, fieldsMapping, fields$2.name)
    })), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "full-name"
    }, field(member, fieldsMapping, fields$2.fullName)), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "position"
    }, field(member, fieldsMapping, fields$2.position)), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "eid"
    }, /*#__PURE__*/React__default["default"].createElement("span", null, `EID\u00A0\u00A0\u00A0${field(member, fieldsMapping, fields$2.eid)}`))), /*#__PURE__*/React__default["default"].createElement("div", {
      className: "footer"
    }, /*#__PURE__*/React__default["default"].createElement("img", {
      src: favLogoBase64,
      alt: "fs-logo"
  ...
  const qrCodes$1 = {};
  const Back = /*#__PURE__*/React$1.forwardRef((_ref, ref) => {
    let {
      member,
      fieldsMapping,
      preview
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "container back surfside",
      ref: ref
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-container"
    }, /*#__PURE__*/React.createElement("div", {
      className: "line-1"
    }, "Authorized access to"), /*#__PURE__*/React.createElement("div", {
      className: "line-2"
    }, "Shelter Access"), /*#__PURE__*/React.createElement("div", {
      className: "line-3"
    }, "Scan QR Code to verify current status")), /*#__PURE__*/React.createElement("div", {
      className: "timestamp"
  ...
  const getFormattedDate = () => {
    const now = new Date();
    return addLeadingZero(now.getDate().toString()) + '-' + addLeadingZero((now.getMonth() + 1).toString()) + '-' + now.getFullYear().toString() + ' (' + addLeadingZero(now.getHours().toString()) + ':' + addLeadingZero(now.getMinutes().toString()) + ')';
  };

  const addLeadingZero = string => string.length === 2 ? string : `0${string}`;

  var css_248z$5 = ".surfside.container {\n  width: 270px;\n  height: 430px;\n  position: relative;\n  overflow: hidden;\n  background: #ffffff;\n}\n\n.surfside .header {\n  height: 50px;\n}\n\n.surfside .body {\n  position: relative;\n  height: 317px;\n  padding: 0 20px;\n}\n\n.surfside .body.white {\n  background-color: rgb(229, 229, 229);\n}\n\n.surfside .body.orange {\n  background-color: rgb(205, 132, 118);\n}\n\n.surfside .body.violet {\n  background-color: rgb(132, 81, 213);\n}\n\n.surfside .body.red {\n  background-color: rgb(188, 78, 65);\n}\n\n.surfside .body.grey {\n  background-color: rgb(175, 176, 192);\n}\n\n.surfside .body.blue {\n  background-color: rgb(64, 112, 238);\n}\n\n.surfside .body.pink {\n  background-color: rgb(217, 93, 223);\n}\n\n.surfside .body.cyan {\n  background-color: rgb(169, 224, 214);\n}\n\n.surfside .body.yellow {\n  background-color: rgb(230, 228, 103);\n}\n\n.surfside .body.green {\n  background-color: rgb(109, 150, 66);\n}\n\n.surfside .footer {\n  height: 63px;\n  text-align: center;\n  line-height: 63px;\n  font-size: 40px;\n  padding: 0 20px;\n}\n\n.surfside .avatar-row {\n  display: flex;\n  height: 125px;\n}\n\n.surfside .avatar {\n  flex-shrink: 0;\n  margin-right: 8px;\n  height: 125px;\n  width: 125px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  overflow: hidden;\n}\n\n.surfside .portrait .img {\n  width: 125px;\n}\n\n.surfside .landscape .img {\n  height: 125px;\n}\n\n.surfside .position {\n  padding-top: 10px;\n  min-width: 0;\n}\n\n.surfside .label {\n  font-size: 10px;\n  margin-bottom: 3px;\n  font-weight: 800;\n}\n\n.surfside .value {\n  width: 100%;\n}\n\n.scaletext-wrapper span {\n  white-space: nowrap;\n  display: block;\n  height: 100%;\n}\n\n.surfside .last-name {\n  font-size: 29px;\n  height: 40px;\n}\n\n.surfside .organization {\n  margin-top: 10px;\n}\n\n.surfside .organization .value > div {\n  height: 55.5px;\n}\n\n.surfside .name {\n  height: 90px;\n  margin-top: 10px;\n}\n\n.surfside .badge-container {\n  display: flex;\n}\n\n.surfside .badge-side-container {\n  border: 5px solid #dbdbdb;\n  margin-right: 20px;\n}\n\n.surfside .qr-code {\n  height: 230px;\n  width: 230px;\n  position: absolute;\n  bottom: 10px;\n  left: 20px;\n}\n\n.surfside .merit-logo {\n  width: 50px;\n  height: 50px;\n  position: absolute;\n  bottom: 90px;\n  left: 50%;\n  transform: translateX(-50%);\n}\n\n.surfside .text-container {\n  text-align: center;\n  padding-top: 40px;\n}\n\n.surfside .line-1 {\n  font-size: 12px;\n  margin-bottom: 20px;\n}\n\n.surfside .line-2 {\n  font-size: 26px;\n  margin-bottom: 27px;\n}\n\n.surfside .line-3 {\n  font-size: 12px;\n  margin-bottom: 13px;\n}\n\n.surfside .timestamp {\n  padding-left: 20px;\n  font-size: 8px;\n}";
  styleInject(css_248z$5);

  const Front = /*#__PURE__*/React$1.forwardRef((_ref, ref) => {
    let {
      member,
      avatarFormat,
      fieldsMapping,
    ...
    const [avatarClasses, setAvatarClasses] = React$1.useState('avatar ' + avatarFormat);
    const badgeClass = `body ${getBadgeColor(member[fieldsMapping[fields$1.category]])}`;
    React$1.useEffect(() => {
      setAvatarClasses('avatar ' + avatarFormat);
    }, [avatarFormat]);
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "value"
    }, member[fieldsMapping[fields$1.position]]))), /*#__PURE__*/React.createElement("div", {
      className: "name"
    }, /*#__PURE__*/React.createElement("div", {
      className: "label"
    }, "Name"), /*#__PURE__*/React.createElement("div", {
      className: "value last-name parent"
    }, /*#__PURE__*/React.createElement(ScaledText, {
      text: member[fieldsMapping[fields$1.lastName]] || ''
    })), /*#__PURE__*/React.createElement("div", {
      className: "value"
    }, member[fieldsMapping[fields$1.firstName]])), /*#__PURE__*/React.createElement("div", {
      className: "organization"
    }, /*#__PURE__*/React.createElement("div", {
      className: "label"
    }, "Organization"), /*#__PURE__*/React.createElement("div", {
      className: "value"
    }, member[fieldsMapping[fields$1.organization]]))), /*#__PURE__*/React.createElement("div", {
      className: "footer"
    }, /*#__PURE__*/React.createElement(ScaledText, {
      text: member[fieldsMapping[fields$1.category]]
    })));
  });
  ...
  var css_248z$4 = ".container.wristband {\n  width: 285px;\n  height: 1185px;\n  position: relative;\n  background-color: #fff;\n  padding: 7.5px;\n}\n\n.wristband .qr-code {\n  width: 285px;\n}\n\n.wristband .merit-logo {\n  width: 55px;\n  height: 55px;\n  position: absolute;\n  top: 150px;\n  left: 50%;\n  transform: translateX(-50%) translateY(-50%);\n}\n\n.wristband .text {\n  text-align: center;\n  margin-top: 15px;\n  font-size: 24px;\n}\n\n@page {\n  margin: 0mm;\n  size: 300px 1200px;\n}";
  styleInject(css_248z$4);

  const qrCodes = {};
  const WristBand = /*#__PURE__*/React$1.forwardRef((_ref, ref) => {
    let {
      member,
      fieldsMapping,
      preview
    } = _ref;
    const qrId = preview ? `qr-code-preview` : `qr-code-${member[fieldsMapping[fields.uid]]}`;
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "text initials"
    }, field(member, fieldsMapping, fields.initials)), /*#__PURE__*/React.createElement("div", {
      className: "text user-id"
    }, field(member, fieldsMapping, fields.id)));
  });
  ...
  var badges = {
    certMembership: {
      back: Back$2,
      front: Front$2,
      fields: Object.values(fields$3),
      title: 'CERT Membership'
    },
    favStuffing: {
      back: Back$1,
      front: Front$1,
      fields: Object.values(fields$2),
  ...
  const BadgeList = _ref => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "badges-list-contaner"
    }, /*#__PURE__*/React.createElement("div", {
  ...
  var css_248z$2 = ".fields-mapping-container {\n  border-right: 1px solid rgb(236, 239, 245);\n  transition: all 0.3s ease;\n  width: 100%;\n  max-width: 300px;\n}\n\n.fields-mapping-container.collapsed {\n  width: 45px;\n}\n\n.fields {\n  padding: 12px;\n}\n\n.row:not(:last-child) {\n  margin-bottom: 16px;\n}\n\n.label {\n  display: block;\n  font-size: 13px;\n  font-weight: 600;\n  margin-bottom: 3px;\n} \n\n.icon-button {\n  margin: 0;\n  position: absolute;\n  top: 6px;\n  right: 6px;\n  background-color: rgba(80, 114, 249, 0.082);\n  border: 1px solid rgb(80, 114, 249);\n  border-radius: 50%;\n  height: 33px;\n  width: 33px;\n  color: rgb(80,114,249);\n  padding: 0;\n}\n\n.icon-button:hover {\n  background-color: rgba(80, 114, 249, 0.16);\n}\n\n.icon-button:active {\n  background-color: rgba(80, 114, 249, 0.243);\n}\n\n.fields-mapping-title {\n  transform: rotate(-180deg);\n  text-align: center;\n  writing-mode: vertical-lr;\n  padding: 30px 11px;\n}\n\n.control {\n  background-color: rgb(247, 249, 252);\n  border-radius: 4px;\n  border: 1px solid rgb(221, 225, 235);\n  padding: 5px 16px;\n  font-weight: 600;\n  font-family: 'Inter var', sans-serif;\n  color: rgb(48, 54, 69);\n  width: 100%;\n}\n\n.control:hover {\n  background-color: rgb(236, 239, 245);\n}\n\n.control:focus {\n  border: 1px solid rgb(80, 114, 249);\n  background-color: #fff;\n}";
  styleInject(css_248z$2);

  const FieldsMapping = _ref => {
    let {
      badgeFields,
      dataFields,
      fieldsMapping,
    ...
    const [collapsed, setCollapsed] = React$1.useState(badgeFields.every(bf => dataFields.indexOf(bf) !== -1));
    React$1.useEffect(() => {
    ...
    return collapsed ? /*#__PURE__*/React.createElement("div", {
      ...
      className: "fields-mapping-title"
    }, "Fields Mapping")) : /*#__PURE__*/React.createElement("div", {
      className: containerClasses
    }, /*#__PURE__*/React.createElement("div", {
      className: "card-header"
    }, "Fields Mapping", /*#__PURE__*/React.createElement("button", {
      className: "icon-button",
      onClick: () => setCollapsed(true)
    }, "<<")), /*#__PURE__*/React.createElement("div", {
      className: "fields"
    }, badgeFields.map(field => /*#__PURE__*/React.createElement("div", {
      className: "row",
      key: field
      ...
      className: "control",
      value: fieldsMapping[field],
      onChange: event => onMappingChange(field, event.target.value)
    }, /*#__PURE__*/React.createElement("option", {
      hidden: true,
      value: undefined
    }, " -- select an option -- "), dataFields.map(field => /*#__PURE__*/React.createElement("option", {
      value: field,
      key: field
    }, field))))))));
  };
  ...
  const Badge = _ref => {
    ...
    const badges = members.length > 0 ? members.map((member, index) => /*#__PURE__*/React.createElement("div", {
      ...
      onFormatChange: () => {}
    }))), badge.back && /*#__PURE__*/React.createElement("div", {
      className: "back"
    }, /*#__PURE__*/React.createElement("span", {
      className: "heading"
    ...
    const preview = selected != null ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
      className: "badge-container"
    }, /*#__PURE__*/React.createElement("div", {
      className: "front"
    }, /*#__PURE__*/React.createElement("span", {
      ...
      fieldsMapping: fieldsMapping,
      preview: true
    })))), !badge.noAvatar && /*#__PURE__*/React.createElement("button", {
      onClick: () => changeFormat(avatarFormat === 'portrait' ? 'landscape' : 'portrait')
    }, "Recrop Avatar")) : 'Please click on one of the elements to see the preview';
    return /*#__PURE__*/React.createElement("div", {
      className: "badge-contaner"
    }, /*#__PURE__*/React.createElement("div", {
      className: "badge"
    }, /*#__PURE__*/React.createElement("div", {
      className: "preview"
  ...
  const Printer = _ref => {
    ...
    const print = () => {
      ...
      w.document.write(`
        ...
        <body>
          ${badgeRefs.map(badge => {
      return badge.back.current ? badge.front.current.outerHTML + badge.back.current.outerHTML : badge.front.current.outerHTML;
    }).join('')}
        </body>
  ...
  var Container = function Container(_ref) {
    ...
    var handleMappingChange = function handleMappingChange(field, value) {
      var mapping = Object.assign({}, fieldsMapping, _defineProperty({}, field, value));
      setFieldsMapping(mapping);
    };

    var _useState3 = React$1.useState({}),
        _useState4 = _slicedToArray(_useState3, 2),
        fieldsMapping = _useState4[0],
        setFieldsMapping = _useState4[1];
